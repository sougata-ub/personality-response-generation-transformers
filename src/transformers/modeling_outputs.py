...
class BaseModelOutputCustom(ModelOutput):
    ...
    fact_preds_stacked: Optional[torch.FloatTensor] = None
    hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    attentions: Optional[Tuple[torch.FloatTensor]] = None
    strategy_prediction: Optional[torch.FloatTensor] = None
    personality_prediction: Optional[torch.FloatTensor] = None
...
@dataclass
class Seq2SeqModelOutputCustom(ModelOutput):
    """
    Base class for model encoder's outputs that also contains : pre-computed hidden states that can speed up sequential
    decoding.
    ...
    encoder_hidden_states: Optional[Tuple[torch.FloatTensor]] = None
    encoder_attentions: Optional[Tuple[torch.FloatTensor]] = None
    fact_preds: Optional[torch.FloatTensor] = None
    opinion_preds: Optional[torch.FloatTensor] = None
    strategy_prediction: Optional[torch.FloatTensor] = None
    personality_prediction: Optional[torch.FloatTensor] = None
    # action_prediction: Optional[torch.FloatTensor] = None
    # reaction_prediction: Optional[torch.FloatTensor] = None
    # additional_prediction: Optional[torch.FloatTensor] = None
...
@dataclass
class Seq2SeqLMOutputCustom(ModelOutput):
    """
    Base class for sequence-to-sequence language models outputs.
    ...
    strategy_prediction: Optional[torch.FloatTensor] = None
    personality_prediction: Optional[torch.FloatTensor] = None
    fact_selection_loss: Optional[torch.FloatTensor] = None
    strategy_pred_loss: Optional[torch.FloatTensor] = None
    personality_pred_loss: Optional[torch.FloatTensor] = None
